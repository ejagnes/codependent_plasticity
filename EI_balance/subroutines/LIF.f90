...
!=========================== update of synaptic conductances ==============================!
	...
	x(6) = x(6)*p_syn(5)
!==========================================================================================!
!=============== variables accumulating current values for EI ratio =======================!
	x(24) = x(24) + x(3)*x(1)			!AMPA
	x(25) = x(25) + x(6)*x(1)*x(8)			!NMDA
	x(26) = x(26) + x(4)*(x(1) - p_syn(2))		!GABA_A
	x(27) = x(27) + x(1) - p_ne(2)			!Leak
	x(28) = x(28) + x(2)*p_ne(7)*(x(1) - p_ne(6))	!AHP
	x(29) = x(29) + (x(25)/x(26))			!E/I
!==========================================================================================!
	END SUBROUTINE
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

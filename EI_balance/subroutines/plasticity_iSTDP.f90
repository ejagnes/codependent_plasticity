...
!============================= finding which input neurons spiked =========================!
	WHERE(spk(j0:jf))
		...
		msynw(j0:jf) = msynw(j0:jf) + p_plast(27)*(ypost(j0:jf)-p_plast(28))		!update weights
	END WHERE
!==========================================================================================!
!=========================== updates when post neuron spikes ==============================!
	IF(spk_post) THEN
		...
		msynw(j0:jf) = msynw(j0:jf) + p_plast(27)*ypre(j0:jf)				!update weights

...
p for [i=2:9] working_directory."data06.dat" every ::1000::1300 u ($1/1000):(10*column(i)) w l
...
set ytics 1
set xtics 0.01
p for [i=2:9] working_directory."data06.dat" every ::17000::19000 u ($1/60000):(10*column(i)) w l
